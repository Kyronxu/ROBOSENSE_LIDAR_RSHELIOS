...
Please download the **rslidar_sdk.tar.gz**(such as rslidar_sdk-v1.5.16.tar.gz) archive instead of Source code. The Source code zip file does not contain the submodule rs_driver, so it has to be downloaded manaully.
